<form class="form-horizontal" action="{{route('store')}}" id="snedPaymentApi" method="post"
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control en-style" id="callback" placeholder="https://sandbox.payro24.ir/callback" name="callback" @if(isset($order)) disabled  value="{{$order->callback}}" @else  value="{{url('/callback')}}" @endif>
        </div>
    </div>
